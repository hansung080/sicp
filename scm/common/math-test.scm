...
(test "expmod"
      (lambda ()
        (assert-eq (expmod 0 0 3) 1)
        (assert-eq (expmod 0 1 3) 0)
        (assert-eq (expmod 0 2 3) 0)
        (assert-eq (expmod 2 0 3) 1)
        (assert-eq (expmod 2 1 3) 2)
        (assert-eq (expmod 2 2 3) 1)
        (assert-eq (expmod 2 3 3) 2)
        (assert-eq (expmod 2 8 3) 1)
        (assert-eq (expmod 2 11 3) 2)
        (assert-eq (expmod 2 0 1) 0)
        (assert-eq (expmod 2 1 1) 0)
        (assert-eq (expmod 2 2 1) 0)
        (assert-eq (expmod 2 0 -1) 0)
        (assert-eq (expmod 2 1 -1) 0)
        (assert-eq (expmod 2 2 -1) 0)))
